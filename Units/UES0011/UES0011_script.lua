...
UES0011 = Class(TConstructionUnit, CSeaUnit) {

	IsWaiting = false,

    Weapons = {
        Gun = Class(TDFMachineGunWeapon) {
        },
    },	
	...
	OnStopBeingBuilt = function(self,builder,layer)
		...
		self.Station01 = CreateUnitHPR('uel0010', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station01:AttachBoneTo(0, self, 'Attachpoint01')
		self.Station02 = CreateUnitHPR('uel0010', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station02:AttachBoneTo(0, self, 'Attachpoint02')
		self.Station03 = CreateUnitHPR('uel0010', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station03:AttachBoneTo(0, self, 'Attachpoint03')
		self.Station04 = CreateUnitHPR('uel0010', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station04:AttachBoneTo(0, self, 'Attachpoint04')
		self.Station05 = CreateUnitHPR('uel0010', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station05:AttachBoneTo(0, self, 'Attachpoint05')
		self.Station06 = CreateUnitHPR('uel0010', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station06:AttachBoneTo(0, self, 'Attachpoint06')
		self.Station07 = CreateUnitHPR('uel0010', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station07:AttachBoneTo(0, self, 'Attachpoint07')
		self.Station08 = CreateUnitHPR('uel0010', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station08:AttachBoneTo(0, self, 'Attachpoint08')
		self.Station09 = CreateUnitHPR('uel0010', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station09:AttachBoneTo(0, self, 'Attachpoint09')
		self.Station10 = CreateUnitHPR('uel0010', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station10:AttachBoneTo(0, self, 'Attachpoint010')
		self.Station11 = CreateUnitHPR('uel0010', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station11:AttachBoneTo(0, self, 'Attachpoint11')
		self.Station12 = CreateUnitHPR('uel0010', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station12:AttachBoneTo(0, self, 'Attachpoint12')
		TConstructionUnit.OnStopBeingBuilt(self,builder,layer)
    end,
